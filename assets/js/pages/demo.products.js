$(document).ready(function () {
  ...
  $('#products-datatable').DataTable({
    language: {
      ...
      lengthMenu:
        'Display <select class=\'form-select form-select-sm ms-1 me-1\'><option value="5">5</option><option value="10">10</option><option value="20">20</option><option value="-1">All</option></select> members',
    },
    pageLength: 10,
    columns: [
      {
