...
WHERE members.organization_id = ? AND members.usertype = 'organizer'");
...
if ($row = $users->num_rows > 0) {
    ...
    $result = array('status' => 'success', 'message' => "success getting list of organizers", 'data' => $rows);
    echo json_encode($result);
} else {
    endProcessWithMessage("No Organizers yet");
}
